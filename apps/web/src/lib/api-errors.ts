...
export const ApiErrorCodes = {
  ...
  CATEGORY_SUBCATEGORY_REQUIRED: 'CATEGORY_SUBCATEGORY_REQUIRED',
  CATEGORY_FILTER_REQUIRED: 'CATEGORY_FILTER_REQUIRED',
  CATEGORY_FILTER_INVALID: 'CATEGORY_FILTER_INVALID',
