...
const dictionary = {
  ar: {
    ...
    auth: {
      ...
      googleExpoGoUnavailable: 'تسجيل الدخول بجوجل لا يعمل داخل Expo Go. استخدم نسخة التطبيق المثبتة على الجهاز.',
      appleSignIn: 'المتابعة مع Apple',
      appleSignInError: 'تعذر تسجيل الدخول عبر Apple. حاول مرة أخرى.',
      appleExpoGoUnavailable: 'تسجيل الدخول بآبل لا يعمل داخل Expo Go. استخدم نسخة الآيفون المثبتة.',
  ...
  en: {
    ...
    auth: {
      ...
      googleExpoGoUnavailable: 'Google sign-in does not work in Expo Go. Use the installed native app build.',
      appleSignIn: 'Continue with Apple',
      appleSignInError: 'Could not sign in with Apple. Please try again.',
      appleExpoGoUnavailable: 'Apple sign-in does not work in Expo Go. Use the installed iPhone app.',
